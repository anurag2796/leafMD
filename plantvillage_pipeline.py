...
Orchestrates training, export, and inference for the PlantVillage Disease
Detection System.  All paths and settings are resolved from config/config.yaml.
"""
...
def run_pipeline(args) -> int:
    ...
    best_model = cfg.best_weights_path
